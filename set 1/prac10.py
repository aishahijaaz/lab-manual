...
if input_choice==1: 
	...
	print ("Converted value:", decimal_others (decimal num, choice)) 
elif input choice==2: 
	binary_num=int(input("Enter decimal number"))
	print('Convert to: 1: binary,2: decimal, 3: octal 4: hexadecimal') 
	choice=int(input("Enter Target conversion:\n")) 
	print ("Converted value: ", binary_others (binary num, choice)) 
elif input_choice==3: 
	octal_num=(int(input("Enter decimal number"))
	print ('Convert to: 1: octal, 2: decimal, 3: binary 4: hexadecimal') 		choice=int(input("Enter Target conversion:\n")) 
